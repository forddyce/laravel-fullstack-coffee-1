...
export default function Button({ className = '', disabled, children, variant = 'primary', ...props }: ButtonProps) {
    const baseClasses = `inline-flex items-center px-4 py-2 border rounded-md font-semibold text-xs uppercase tracking-widest shadow-sm hover:cursor-pointer `;
    ...
    switch (variant) {
        case 'primary':
            variantClasses = `bg-brand-primary border-transparent text-white hover:bg-brand-primary/50 focus:bg-brand-primary/50 focus:outline-none focus:ring-2 focus:bg-brand-primary/50 focus:ring-offset-2`;
            break;
        case 'secondary':
        ...
        case 'danger':
            ...
            break;
        default:
            variantClasses = `bg-brand-primary border-transparent text-white hover:bg-brand-primary/50focus:bg-brand-primary/50 focus:outline-none focus:ring-2 focus:bg-brand-primary/50 focus:ring-offset-2`;
            break;
    }
