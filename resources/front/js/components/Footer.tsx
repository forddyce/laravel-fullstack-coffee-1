                ...
                <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
                    ...
                    <div>
                        <div className="mb-4 flex items-center">
                            {/* "WE" Logo - Image tag already from previous ClientFooter component */}
                    ...
                    {/* Empty/Placeholder for Recent Articles */}
                    <div>{/* This section remains empty or can be used for other content */}</div>
                    ...
                    <div>
                        ...
                        <div className="space-y-3">
                            <div className="flex items-start">
                                <MapPin className="mr-3 mt-1 h-5 w-5" /> {/* Replaced SVG */}
                                <p className="text-sm">
                            ...
                            <div className="flex items-start">
                                <Clock className="mr-3 mt-1 h-5 w-5" /> {/* Replaced SVG */}
                                <p className="text-sm">
                            ...
                            <div className="flex items-center">
                                <Phone className="mr-3 h-5 w-5" /> {/* Replaced SVG */}
                                <p className="text-sm">
                                    +62 819-2959-6675 <br />
                                    +62 821-2476-2004 <br />
                                    +62 878-1653-8759
                            ...
                            <div className="flex items-center">
                                <Mail className="mr-3 h-5 w-5" /> {/* Replaced SVG */}
                                <p className="text-sm">inquiry@wiliamedison.coffee</p>
                            </div>
                            <div className="mt-4 flex items-center space-x-4">
                                {/* Social Media Icons */}
                                <a href="#" aria-label="Instagram" className="hover:text-gray-300">
                                    <Instagram className="h-6 w-6" /> {/* Replaced SVG */}
                                </a>
                                <a href="#" aria-label="Facebook" className="hover:text-gray-300">
                                    <Facebook className="h-6 w-6" /> {/* Replaced SVG */}
                                </a>
                                <a href="#" aria-label="YouTube" className="hover:text-gray-300">
                                    <Youtube className="h-6 w-6" /> {/* Replaced SVG */}
                                </a>
                            </div>
                        </div>
                    </div>
