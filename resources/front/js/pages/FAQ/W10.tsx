...
import { w10Items as items } from '@/front/js/utils/faq';
import { Head } from '@inertiajs/react';

export default function FaqW10Page() {
    return (
        <ClientLayout>
            <Head title={'FAQ - W 1.0 & W 1.1 - WE Coffee Roasters'} />
            <div className="py-8">
                <div className="mx-auto max-w-4xl rounded-lg bg-white p-6 px-4 sm:px-6 lg:px-8">
                    <h1 className="title-underline mb-6 text-center text-4xl font-bold text-gray-900">W 1.0 & W 1.1</h1>
